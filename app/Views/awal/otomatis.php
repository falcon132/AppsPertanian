...
<body>
    <div class="table-responsive" align="center">
        <div class="gambar">
            <img src="<?php echo base_url() ?>/assets/img/indmira (6).png" class="img-fluid rounded-pill" alt="PADI">
        </div>
        <table class="table">
            <tr>
                <td>
                    <div class="col">
                        <a href="<?php echo base_url() ?>/kalkulator/padi_awal"><img src="<?php echo base_url() ?>/assets/img/indmira3.png" class="img-fluid" alt="PADI"></a>
                    </div>
                </td>
                <td>
                    <div class="col">
                        <a href="<?php echo base_url() ?>/kalkulator/bawang_awal"><img src="<?php echo base_url() ?>/assets/img/indmira5.png" class="img-fluid " alt="BAWANG MERAH"></a>
                    </div>
                </td>
                <td>
                    <div class="col">
                        <a href="<?php echo base_url() ?>/kalkulator/sawit_awal"><img src="<?php echo base_url() ?>/assets/img/indmira6.png" class="img-fluid" alt="SAWIT"></a>
                    </div>
                </td>
            </tr>
        </table>
