...
<div class="table-responsive" align="center">
    ...
    <table class="table">
        <tr>
            <td>
                <div class="col">
                    <a href="<?php echo base_url() ?>/calculationpangan"><img src="<?php echo base_url() ?>/assets/img/indmira3.png" class="img-fluid" alt="PANGAN"></a>
                </div>
            </td>
            <td>
                <div class="col">
                    <a href="<?php echo base_url() ?>/calculationhorti"><img src="<?php echo base_url() ?>/assets/img/indmira5.png" class="img-fluid " alt="HORTI"></a>
                </div>
            </td>
            <td>
                <div class="col">
                    <a href="<?php echo base_url() ?>/calculation"><img src="<?php echo base_url() ?>/assets/img/indmira6.png" class="img-fluid" alt="PERKEBUNAN"></a>
                </div>
            </td>
        </tr>
    </table>
