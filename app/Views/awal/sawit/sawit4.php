...
//Data Input 
{
    ...
    /// tahun ke 3 up //
    $vol_gliposat = 0.0005;
    $harga_gliposat = 52000;
    $tt_gliposat = 26;
    $vol_perekat = 0.0008333333;
    $harga_perekat = 26000;
    $tt_perekat = 21.66666667;
    $vol_ally = 0.005 / 3;
    $harga_ally = 10000;
    $tt_ally = 16.66666667;
    $vol_parakuat = 0.00045 / 3;
    $harga_parakuat = 50000;
    $tt_parakuat = 7.5;
    $vol_gramoxon = 0.00075 / 3;
    $harga_gramoxon = 70000;
    $tt_gramoxon = 0;
    $totalpindah = 71.83333333;
    $harga_urea2 = 7000;
    $tt_urea2 = 245;
    $harga_tsp2 =  6000;
    $tt_tsp2 = 147;
    ...
    $harga_san2 = 27000;
    $tt_san2 = 16.2;
    $harga_fruttago =  84000;
    $tt_fruttago = 25.2;
    $harga_kalsigro = 12000;
    $tt_kalsigro = 3.6;
    $harga_mix = 30000;
    $tt_mix = 36;
    $harga_metar = 30000;
    ...
    $tt_babat = 160;
    $Vol_semprot = 0.00005;
    $harga_semprot =  130000;
    $tt_semprot = 13;
    $vol_pupuk = 0.0008;
    $harga_pupuk = 130000;
    $tt_pupuk = 104;
    $vol_kastrasi =  0.0002;
    $harga_kastrasi = 130000;
    $tt_kastrasi = 26;
    $vol_investasi = 0.0001;
    $harga_investasi = 130000;
    $tt_investasi = 13;
    $umurpindah = 80;
    $tt_umurpindah = 160;
    $vol_babat = 0.00005;
    ...
    $harga_tenagapiringanmanual = 130000;
    $tt_tenagapiringanmanual = 104;
    $vol_tenagapiringanchemis =   0.000028571429;
    $harga_tenagapiringanchemis = 130000;
...
//rumus//
{
    ...
    $hasil44 = $harga_gliposat;
    $hasil45 = $hasil43 * $harga_gliposat;
    $hasil46 = $vol_perekat * $angka;
    $hasil47 = $harga_perekat;
    $hasil48 = $tt_perekat * $angka;
    $hasil49 = $vol_ally * $angka;
    $hasil50 = $harga_ally;
    $hasil51 = $tt_ally * $angka;
    $hasil52 = $vol_parakuat * $angka;
    $hasil53 = $harga_parakuat;
    $hasil54 = $tt_parakuat * $angka;
    $hasil55 = $vol_gramoxon * $angka;
    $hasil56 = $harga_gramoxon;
    $hasil57 = $tt_gramoxon * $angka;
    $hasil58 = $harga_urea2;
    $hasil59 = $harga_tsp2;
    $hasil60 = $harga_mop2;
    $hasil61 = $harga_dolomint2;
    $hasil62 = $harga_borat2;
    $hasil63 = $harga_san2;
    $hasil64 = $harga_fruttago;
    $hasil65 = $harga_kalsigro;
    $hasil66 = $harga_mix;
    $hasil67 = $harga_metar;
    ...
    $hasil101 = $harga_tenagapiringanmanual;
    $hasil102 = $vol_tenagapiringanchemis * $angka;
    $hasil103 = $harga_tenagapiringanchemis;
    $hasil104 = $vol_tbm * $angka;
    $hasil105 = $harga_tbm;
    $hasil106 = $vol_tunas * $angka;
    $hasil107 = $harga_tunas;
    $hasil108 = $th34;
    $hasil109 = $th56;
    $hasil110 = $th79;
    $hasil111 = $th915;
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo 0.00025 * $angka ?></td>
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo 0.000175 * $angka ?></td>
                                    <td style="width: 50px;"><?php echo number_format($hasil1, 0, ".", ",") . " pohon"; ?></td>
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo 0.000005 * $angka ?></td>
                                    <td style="width: 50px;"><?php echo number_format($hasil1, 0, ".", ",") . " pohon"; ?></td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo  number_format($hasil100 * 2, 1, ".", ",") . " HOK "; ?></td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo (7.1428571 / 10000) * $angka ?></td>
