                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo 0.00035 * $angka ?></td>
                                    <td style="width: 50px;"><?php echo number_format($hasil1, 0, ".", ",") . " pohon"; ?></td>
                                    <td style="width: 70px;">Rp. 10.000,00</td>
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo 0.00001 * $angka ?></td>
                                    <td style="width: 50px;"><?php echo number_format($hasil1, 0, ".", ",") . " pohon"; ?></td>
                    ...
                    <form method="post">
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    <td>Fruttagro</td>
                                    <td style="width: 50px;"><?php echo (3.5 / 10000) * $angka ?></td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo (3.318 / 10000) * $angka . " HOK "; ?></td>
                                    <td style="width: 70px;">Rp. 130.000,00</td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo (26.66666667 / 10000) * $angka ?></td>
                                    <td style="width: 70px;">Rp. 130.000,00</td>
