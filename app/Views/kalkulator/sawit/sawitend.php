    ...
    <form method="post">
        <div class="card text-center">
            <div class="card-header">
                Sawit Periode tahun ke 20 keatas
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo 0.000225 * $angka ?></td>
                                    <td style="width: 50px;"><?php echo number_format($hasil1, 0, ".", ",") . " pohon"; ?></td>
                    ...
                    <form method="post">
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    <td>SAN tanaman</td>
                                    <td style="width: 50px;"><?php echo (9 / 10000) * $angka ?></td>
                    ...
                    <form method="post">
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    <td>>20 th : 1372 kg</td>
                                    <td style="width: 50px;"><?php echo (2.744 / 10000) * $angka . " HOK "; ?></td>
                                    <td style="width: 70px;">Rp. 130.000,00</td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" align="center" border="3" bgcolor="white">
                                ...
                                <tr style="width: 100px;">
                                    ...
                                    <td style="width: 50px;"><?php echo (25.5 / 10000) * $angka ?></td>
