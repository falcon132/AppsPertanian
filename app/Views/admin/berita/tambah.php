	...
	<div class="form-group row">
		...
		<div class="col-md-2">
			<select name="jenis_berita" class="form-control">
				...
				<option value="Layanan">BAWANG = Panduan Budidaya</option>
				<option value="Profil">BAWANG = Identifikasi Penyakit</option>
				<option value="SolusiBawang">BAWANG = Solusi Penyakit</option>
				<option value="Perikanan">PADI = Panduan Budidaya</option>
				<option value="Perkebunan">PADI = Identifikasi Penyakit</option>
				<option value="SolusiPadi">PADI = Solusi Penyakit</option>
				<option value="SawitPB">SAWIT = Panduan Budidaya</option>
				<option value="SawitIP">SAWIT = Identifikasi Penyakit</option>
				<option value="SolusiSawit">SAWIT = Solusi Penyakit</option>
			</select>
