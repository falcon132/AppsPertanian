		...
		<div class="col-md-2">
			<select name="jenis_berita" class="form-control">
				...
				<option value="Layanan" <?php if ($berita['jenis_berita'] == "Layanan") {
											echo 'selected';
										} ?>>BAWANG = Panduan Budidaya</option>
				<option value="Profil" <?php if ($berita['jenis_berita'] == "Profil") {
											echo 'selected';
										} ?>>BAWANG = Identifikasi Penyakit</option>
				<option value="SolusiBawang" <?php if ($berita['jenis_berita'] == "SolusiBawang") {
													echo 'selected';
												} ?>>BAWANG = Solusi Penyakit</option>
				<option value="Perikanan" <?php if ($berita['jenis_berita'] == "Perikanan") {
												echo 'selected';
											} ?>>PADI = Panduan Budidaya</option>
				<option value="Perkebunan" <?php if ($berita['jenis_berita'] == "Perkebunan") {
												echo 'selected';
											} ?>>PADI = Identifikasi Penyakit</option>
				<option value="SolusiPadi" <?php if ($berita['jenis_berita'] == "SolusiPadi") {
												echo 'selected';
											} ?>>PADI = Solusi Penyakit</option>
				<option value="SawitPB" <?php if ($berita['jenis_berita'] == "SawitPB") {
											echo 'selected';
										} ?>>SAWIT = Panduan Budidaya</option>
				<option value="SawitIP" <?php if ($berita['jenis_berita'] == "SawitIP") {
											echo 'selected';
										} ?>>SAWIT = Identifikasi Penyakit</option>
				<option value="SolusiSawit" <?php if ($berita['jenis_berita'] == "SolusiSawit") {
												echo 'selected';
											} ?>>SAWIT = Solusi Penyakit</option>
			</select>
