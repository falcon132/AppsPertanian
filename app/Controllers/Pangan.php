...
class Pangan extends BaseController
{
    ...
    public function padi()
    {
        ...
        $data = [
            ...
            'keywords'        => 'Kontak Kami ',
            'slider'        => $slider,
            'content'        => 'komoditas/pangan/padi/index'
        ];
        echo view('layout/wrapper', $data);
    }
    public function panduan_padi()
    {
        $m_galeri        = new Galeri_model();
        $slider         = $m_galeri->slider();
        ...
        $data = [
            ...
            'keywords'        => 'Kontak Kami ',
            'slider'        => $slider,
            'content'        => 'komoditas/pangan/padi/panduan'
        ];
        echo view('layout/wrapper', $data);
    }
    // end tampilan sub-menu perikanan pada tab home//
    public function hama_padi()
    {
        $m_galeri        = new Galeri_model();
        $slider         = $m_galeri->slider();
        ...
        $data = [
            ...
            'keywords'        => 'Kontak Kami ',
            'slider'        => $slider,
            'content'        => 'komoditas/pangan/padi/hama'
        ];
        echo view('layout/wrapper', $data);
    }
    public function solusi_padi()
    {
        $m_galeri        = new Galeri_model();
        $slider         = $m_galeri->slider();
        ...
        $data = [
            ...
            'keywords'        => 'Kontak Kami ',
            'slider'        => $slider,
            'content'        => 'komoditas/pangan/padi/solusi'
        ];
        echo view('layout/wrapper', $data);
    }
}
